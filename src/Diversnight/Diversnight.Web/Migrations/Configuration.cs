...
namespace Diversnight.Web.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Diversnight.Web.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(Diversnight.Web.Models.ApplicationDbContext context)
        {
        ...
        private void AddCountries(ApplicationDbContext context)
        {
        ...
        bool AddUserAndRole(Diversnight.Web.Models.ApplicationDbContext context)
        {
            IdentityResult ir;
            ...
            var user = context.Users.FirstOrDefault(u => u.UserName == "thomas@tkalve.no");
            if (user != null)
                ir = um.AddToRole(user.Id, "Admin");
            user = context.Users.FirstOrDefault(u => u.UserName == "ludvig@aarstad.org");
            if (user != null)
                ir = um.AddToRole(user.Id, "Admin");
            return ir.Succeeded;
        }
